...
@pytest.fixture
def smhi(get_data: dict[str, Any]) -> Smhi:
...
@pytest.fixture
def smhi_forecasts(smhi:Smhi) -> List[SmhiForecast]:
    """Returns the smhi object."""
    return smhi.get_forecast()

@pytest.fixture
def smhi_forecasts_hour(smhi:Smhi) -> List[SmhiForecast]:
    """Returns the smhi object."""
    return smhi.get_forecast_hour()

@pytest.fixture
def first_smhi_forecast(smhi:Smhi) -> SmhiForecast:
    """Returns the smhi object."""
    return smhi.get_forecast()[1]


@pytest.fixture
def first_smhi_forecast2(smhi:Smhi) -> SmhiForecast:
    """Returns the smhi object."""
    return smhi.get_forecast()[2]

@pytest.fixture
def first_smhi_forecast_hour(smhi:Smhi) -> SmhiForecast:
    """Returns the smhi object."""
...
def test_temperature_hour(first_smhi_forecast_hour:SmhiForecast):
    """test"""
    assert first_smhi_forecast_hour.temperature == 16


def test_temperature(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.temperature == 17


def test_temperature_max(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.temperature_max == 17


def test_temperature_min(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.temperature_min == 7


def test_humidity(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.humidity == 55


def test_pressure(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.pressure == 1024


def test_thunder(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.thunder == 33


def test_cloudiness(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.cloudiness == 50


def test_precipitation(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.precipitation == 1


def test_mean_precipitation(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.mean_precipitation == 0.08333333333333333


def test_total_precipitation(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.total_precipitation == 2.0


def test_wind_speed(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.wind_speed == 1.9


def test_wind_direction(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.wind_direction == 134


def test_wind_gust(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.wind_gust == 4.7


def test_horizontal_visibility(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.horizontal_visibility == 50


def test_symbol(first_smhi_forecast:SmhiForecast):
    """test"""
    assert first_smhi_forecast.symbol == 1


def test_valid_time(first_smhi_forecast:SmhiForecast):
    """test"""
...
async def test_smhi_async_get_forecast_integration(smhi:Smhi):
...
async def test_smhi_async_get_forecast_integration_use_session(smhi:Smhi):
    """test the async stuff"""
...
# def test_precipitation_mean_value(smhi:Smhi):
...
def get_fake_data_from_smhi() -> Smhi:
    """Returns the smhi object."""

    return {
        "approvedTime": "2018-09-01T14:06:18Z",
        "referenceTime": "2018-09-01T14:00:00Z",
        "geometry": {"type": "Point", "coordinates": [[16.024394, 63.341937]]},
        "timeSeries": [
            {
